...
@export var ControlHints: Dictionary[int, String] = {
	0: "Use TUTORIAL_MOVE_UP TUTORIAL_MOVE_DOWN TUTORIAL_MOVE_LEFT TUTORIAL_MOVE_RIGHT to move, and Mouse to look around.",
